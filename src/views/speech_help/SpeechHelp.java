...
public class SpeechHelp implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		text.setText("All numbers from 11 onwards follow a basic pattern. For example, to say twenty-two, "
				+ "simply say 'rua tekau', which means 20, and then 'm─ rua', which means and two, therefore becomes 'rua tekau m─ rua'. "
				+ "So all you have to do is learn the numbers from 1 - 10 and then the words for "
				+ "10, 20, 30, 40 and so on.\n"
				+ " For example: 60  is 'ono tekau' and 54 is 'rima tekau m─ wh─'");
	}
